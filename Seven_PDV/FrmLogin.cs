    ...
    public partial class FrmLogin : Form
    {
        ...
        private void FrmLogin_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Sistema SEVEN - PDV iniciado.");
                }
                ...
                //
                if (bllLogin.VerificarProcesso("Seven_PDV") > 1)
                {
                    MessageBox.Show("O aplicativo Sistema SEVEN - PDV já está aberto.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    Application.Exit();
                }
                else
                {
        ...
        private async void btnLogar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    if (bllCadastroComputadores.Verificar_Primeira_Conexao() == false)
                    {
                        MessageBox.Show("Antes de iniciar o Sistema SEVEN - PDV, certifique-se de executar o Sistema SEVEN - ADM para concluir as configurações iniciais do sistema.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    }
                    /*
                    else if (bllCadastroComputadores.Verificar_Computador_Cadastrado(Conexao_Codigo[cbbEmpresa.SelectedIndex], "sistemasevenpdv") == false)
                    {
                        MessageBox.Show("Este computador não possui permissão para acessar este aplicativo.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        //
                    ...
                    */
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                DialogResult = MessageBox.Show("Não foram inseridas as informações da empresa, para emitir documentos é necessário inserir as informações da empresa no aplicativo Sistema SEVEN - ADM.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                this.DialogResult = DialogResult.None;
                            }
                            else
                            {
        ...
        private void cbbEmpresa_DropDownClosed(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }
