...
namespace Seven_Sistema
{
    ...
    {
        public FrmAdicionarItem(int item, byte formulario, string tabela, string quantidade)
        {
            InitializeComponent();
            _Item = item.ToString();
        ...
        private void FrmAdicionarItemOrc_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_Formulario == 0)
                {
                    ...
                    //
                    lblValorTotalDescAcresc.Text = Convert.ToDecimal(bllOrcamento.Calculo_Valor_Item_Desc_Acresc_Orc(txtValorUnitario.Text.Trim(), txtValorDesconto.Text.Trim(), txtValorAcrescimo.Text.Trim())).ToString("n2", new CultureInfo("pt-BR"));
                    //
        ...
        {
            MessageBox.Show("Informe a quantidade, unidade de medida, valor unitário, desconto e acréscimo do produto.", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Information);
            this.DialogResult = DialogResult.None;
        }
                ...
                try
                {
                    if (_Formulario == 0)
                    {
                        if (txtDescontoPorc.Text != "")
                        {
                            ...
                            //
                            txtValorDesconto.Text = Convert.ToDecimal(bllOrcamento.Calculo_Desconto(txtValorUnitario.Text, txtDescontoPorc.Text)).ToString("n2", new CultureInfo("pt-BR"));
                            //
                            lblValorTotalDescAcresc.Text = Convert.ToDecimal(bllOrcamento.Calculo_Valor_Item_Desc_Acresc_Orc(txtValorUnitario.Text.Trim(), txtValorDesconto.Text.Trim(), txtValorAcrescimo.Text.Trim())).ToString("n2", new CultureInfo("pt-BR"));
                        }
                        else
                ...
                try
                {
                    if (_Formulario == 0)
                    {
                        if (txtValorDesconto.Text != "")
                        {
                            ...
                            //
                            txtDescontoPorc.Text = Convert.ToDecimal(bllOrcamento.Calculo_ValorDesconto(txtValorUnitario.Text, txtValorDesconto.Text)).ToString("n2", new CultureInfo("pt-BR"));
                            //
                            lblValorTotalDescAcresc.Text = Convert.ToDecimal(bllOrcamento.Calculo_Valor_Item_Desc_Acresc_Orc(txtValorUnitario.Text.Trim(), txtValorDesconto.Text.Trim(), txtValorAcrescimo.Text.Trim())).ToString("n2", new CultureInfo("pt-BR"));
                        }
                        else
                ...
                try
                {
                    if (_Formulario == 0)
                    {
                        if (txtAcrescimoPorc.Text != "")
                        {
                            ...
                            txtValorAcrescimo.Text = Convert.ToDecimal(bllOrcamento.Calculo_Acrescimo(txtValorUnitario.Text, txtAcrescimoPorc.Text)).ToString("n2", new CultureInfo("pt-BR"));
                ...
                try
                {
                    if (_Formulario == 0)
                    {
                        if (txtValorAcrescimo.Text != "")
                        {
                            ...
                            txtAcrescimoPorc.Text = Convert.ToDecimal(bllOrcamento.Calculo_ValorAcrescimo(txtValorUnitario.Text, txtValorAcrescimo.Text)).ToString("n2", new CultureInfo("pt-BR"));
