...
namespace Seven_Sistema
{
    public partial class FrmValorCreditoLoja : Form
    {
        ...
        {
            InitializeComponent();
            _Consumidor = consumidor.Replace("Consumidor: ", "");
            _Usuario = usuario;
        ...
        private void FrmValorCreditoLoja_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //
                _Valor = bllVenda.Sel_Credito_Loja_Cliente_PDV(_Consumidor);
