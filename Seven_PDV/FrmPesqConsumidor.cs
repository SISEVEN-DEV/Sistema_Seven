...
{
    public partial class FrmPesqConsumidor : Form
    {
        public FrmPesqConsumidor(byte formulario, string tabela, string usuario, string cod_pdv_computador)
        {
            InitializeComponent();
        ...
        private void rbtnNomeAluno_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblPesquisar.Location = new Point(348, 21);
        ...
        private void rbtnCodigo_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblPesquisar.Location = new Point(623, 21);
        ...
        private void rbtnCPF_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblPesquisar.Location = new Point(627, 21);
            mtxtpCPF.Text = null;
            mtxtpCPF.Select();
        }
        ...
        private void rbtnCNPJ_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblPesquisar.Location = new Point(592, 21);
            mtxtpCNPJ.Text = null;
            mtxtpCNPJ.Select();
        }
        ...
        private void rbtnRG_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblPesquisar.Location = new Point(608, 21);
        ...
        private void rbtnIE_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblPesquisar.Location = new Point(516, 21);
            txtpNome.MaxLength = 20;
            txtpRG.Text = null;
            txtpRG.Select();
        }
        ...
        private void rbtnCPFResponsavel_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblPesquisar.Location = new Point(536, 21);
            mtxtpCPF.Text = null;
            mtxtpCPF.Select();
        }
        ...
        private void rbtnTodos_CheckedChanged(object sender, EventArgs e)
        {
            ...
            lblPesquisar.Location = new Point(669, 21);
            btnPesquisar.Select();
        }
        ...
        {
            MessageBox.Show("Nesta seção você pesquisará os dados por nome/razão social, código, cpf, cnpj, rg, inscrição estadual, cpf(pai ou mãe), palavra-chave e todos os dados cadastrados.", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Information);
            this.DialogResult = DialogResult.None;
        }
        ...
        private void dtClie_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do datagridview dtClie.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do datagridview dtClie.");
        ...
        private void dtClie_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_Formulario == 0)
                {
                    ...
                    else if (SelectedRow.Cells[18].Value.ToString() == "BLOQUEADO")
                    {
                    ...
                    {
                        bllVenda.Alterar_Consumidor_PDV(SelectedRow.Cells[0].Value.ToString(), SelectedRow.Cells[1].Value.ToString(), SelectedRow.Cells[4].Value.ToString(), _Tabela, bllConexao._Codigo_Conexao);
                        bllVenda._PDV_PesqCliente_Tabela = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString() + "—" + SelectedRow.Cells[4].Value.ToString();
                        //
                ...
                else if (_Formulario == 1)
                {
                    ...
                    {
                        btnIncluir.Select();
                        bllDevolucao._Consumidor_PesqDev = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString() + "—" + SelectedRow.Cells[4].Value.ToString();
                        this.DialogResult = DialogResult.OK;
                    }
                }
                ...
                else if (_Formulario == 3)
                {
                    ...
                    {
                        btnIncluir.Select();
                        bllControleCheque._Consumidor_PesqControleCheque = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString() + "—" + SelectedRow.Cells[4].Value.ToString();
                        this.DialogResult = DialogResult.OK;
                    }
                }
            }
        ...
        private void FrmPesqCliente_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento formclosing do FrmPesqCliente.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento formclosing do FrmPesqCliente.");
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                try
                {
                    ...
                    if (_Formulario == 0)
                    {
                        if (SelectedRow.Cells[4].Value.ToString() == "")
                        {
                            MessageBox.Show("Não é possível incluir um cliente sem CPF/CNPJ.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            this.DialogResult = DialogResult.None;
                        }
                        else if (SelectedRow.Cells[18].Value.ToString() == "BLOQUEADO")
                        {
