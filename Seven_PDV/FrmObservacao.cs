...
namespace Seven_Sistema
{
    ...
    {
        public FrmObservacao(string usuario, string cod_pdv_computador)
        {
            InitializeComponent();
            _Usuario = usuario;
        ...
        private void FrmOutrasOpcoes_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Formulário FrmObservacao iniciado.");
                }
                ...
                //
                if (bllVenda._Observacao != "")
                {
                    rtxtObs.Text = bllVenda._Observacao;
                }
                rtxtObs.Select();
            }
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento load do formulário FrmObservacao.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento load do formulário FrmObservacao.");
        ...
        private void FrmOutrasOpcoes_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void FrmObservacao_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Formulário FrmObservacao foi finalizado.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Formulário FrmObservacao foi finalizado.");
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento formclosing do FrmObservacao.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento formclosing do FrmObservacao.");
        ...
        private void btnSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    bllVenda._Observacao = rtxtObs.Text.Trim();
                    //
        ...
        private void rtxtObs_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        {
            MessageBox.Show("Informação de Observação da venda a ser feita.", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Information);
