...
namespace Seven_Sistema
{
    public partial class FrmSistema : Form
    {
        ...
        private bool _Alternar_Cor_DtItem = true;
        ...
        private int _TamDescTab;
        private bool _Acesso_Negado;
        ...
        private void FrmSistema_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {                  
                    btnTipoVenda.Text = bllConfiguracaoSistema.Sel_Tipo_Documento_Venda(bllConexao._Codigo_Conexao);
                    if (btnTipoVenda.Text == "DAV")
                    {
                        btnTipoVenda.Text = "DAV";
                        lblTipo.Text = "DAV (Documento Auxiliar de Venda):";
                        //
                        lblContAtiva.Visible = false;
                    }
                    else if (btnTipoVenda.Text == "NFCe")
                    {
                        btnTipoVenda.Text = "NFCe";
                        lblTipo.Text = "NFCe (Nota Fiscal de Consumidor Eletrônica - Modelo 65):";
                        //
                    ...
                    else if (btnTipoVenda.Text == "NFe")
                    {
                        btnTipoVenda.Text = "NFe";
                        lblTipo.Text = "NFe (Nota Fiscal Eletrônica - Modelo 55):";
                        //
                        lblContAtiva.Visible = false;
                    }
                    //
                    ...
                    //
                    tslblVersao.Text = "Versão: " + _Versao + "/Nº PDV: " + drComp["id_cadastro_computadores"].ToString();
                    //
                    tslblEmpresa.Text = bllMinhaEmpresa.Sel_Nome_Empresa().Replace("&", "&&"); 
                    //
                    string[] items = tslblUsuario.Text.Remove(0, 12).Split('—');
                    //
                    bllRegistroAtividades.Salvar("O USUARIO " + tslblUsuario.Text.Remove(0, 12) + " LOGOU NO SISTEMA SEVEN PDV.", "USUARIO", "0", tslblUsuario.Text, tslblVersao.Text);
                    //
                    ...
                    {
                        tstbBarraDaEsquerda.Size = new Size(1, 20);
                        _TamDescTab = 332;
                    }
                    else if (Screen.PrimaryScreen.Bounds.Width == 1280 & Screen.PrimaryScreen.Bounds.Height == 1024)
                    {
                        tstbBarraDaEsquerda.Size = new Size(1, 20);
                        _TamDescTab = 332;
                    }
                    ...
                    else if (bllConfiguracaoSistema.Sel_Resolucao_Pdv(bllConexao._Codigo_Conexao) == "1280 x 1024")
                    {
                        tstbBarraDaEsquerda.Size = new Size(1, 20);
                        _TamDescTab = 332;
                    }
                    ...
                    else if (bllConfiguracaoSistema.Sel_Resolucao_Pdv(bllConexao._Codigo_Conexao) == "1440 x 900")
                    {
                        tstbBarraDaEsquerda.Size = new Size(50, 20);
                        _TamDescTab = 484;
                    }
                    else if (bllConfiguracaoSistema.Sel_Resolucao_Pdv(bllConexao._Codigo_Conexao) == "1600 x 900")
                    {
                        tstbBarraDaEsquerda.Size = new Size(150, 20);
                        if (bllConfiguracaoSistema.Sel_Mostrar_Desc_Acresc_Venda(bllConexao._Codigo_Conexao) == true)
                        {
                    ...
                    else if (bllConfiguracaoSistema.Sel_Resolucao_Pdv(bllConexao._Codigo_Conexao) == "1920 x 1080")
                    {
                        tstbBarraDaEsquerda.Size = new Size(300, 20);
                        if (bllConfiguracaoSistema.Sel_Mostrar_Desc_Acresc_Venda(bllConexao._Codigo_Conexao) == true)
                        {
                    ...
                    */
                    ...
                    if (bllConfiguracaoSistema.Sel_Resolucao_Pdv(bllConexao._Codigo_Conexao) == "1280 x 720")
                    {
                        panTabela.Size = new Size(745, 404);
                        dtItems.Size = new Size(736, 349);
                        panTotalProdutos.Location = new Point(746, 512);
                        lblValorTotal.Location = new Point(4, -1);
                        lblTotalProdutos.Location = new Point(293, 0);
                        panTotalProdutos.Size = new Size(530, 120);
                        btnExcluirCliente.Location = new Point(3, 374);
                        panCabecalho.Size = new Size(1260, 65);
                        lblMensagemTopo.Size = new Size(1236, 64);
                        panQuantidade.Location = new Point(531, 512);
                        lblCliente.Location = new Point(35, 378);
                        panMenuImagem.Size = new Size(500, 275);
                        lblImagemProduto.Location = new Point(7, 2);
                        pcibImagemProduto.Size = new Size(498, 248);
                        lblLegendaImagem.Location = new Point(121, 132);
                        btnTabela.Location = new Point(662, 374);
                        
                    }
                    else if (bllConfiguracaoSistema.Sel_Resolucao_Pdv(bllConexao._Codigo_Conexao) == "1366 x 768")
                    {
                        panTabela.Size = new Size(815, 449);
                        dtItems.Size = new Size(809, 392);
                        panTotalProdutos.Location = new Point(746, 561);
                        lblValorTotal.Location = new Point(77, -1);
                        lblTotalProdutos.Location = new Point(363, 0);
                        panTotalProdutos.Size = new Size(600, 120);
                        btnExcluirCliente.Location = new Point(3, 419);
                        panCabecalho.Size = new Size(1330, 65);
                        lblMensagemTopo.Size = new Size(1303, 64);
                        panQuantidade.Location = new Point(531, 561);
                        lblCliente.Location = new Point(35, 423);
                        panMenuImagem.Size = new Size(500, 324);
                        lblImagemProduto.Location = new Point(7, 2);
                        pcibImagemProduto.Size = new Size(498, 297);
                        lblLegendaImagem.Location = new Point(121, 132);
                        btnTabela.Location = new Point(728, 419);
                        _TamDescTab = 358;
                        tstbBarraDaEsquerda.Size = new Size(35, 20);
                    }
                    else if (bllConfiguracaoSistema.Sel_Resolucao_Pdv(bllConexao._Codigo_Conexao) == "1440 x 900")
                    {
                        panTabela.Size = new Size(873, 561);
                        dtItems.Size = new Size(866, 505);
                        panTotalProdutos.Location = new Point(750, 672);
                        lblValorTotal.Location = new Point(127, -1);
                        lblTotalProdutos.Location = new Point(417, 0);
                        panTotalProdutos.Size = new Size(654, 120);
                        btnExcluirCliente.Location = new Point(3, 531);
                        panCabecalho.Size = new Size(1388, 65);
                        lblMensagemTopo.Size = new Size(1366, 64);
                        panQuantidade.Location = new Point(531, 672);
                        lblCliente.Location = new Point(35, 535);
                        panMenuImagem.Size = new Size(500, 435);
                        lblImagemProduto.Location = new Point(7, 2);
                        pcibImagemProduto.Size = new Size(498, 408);
                        lblLegendaImagem.Location = new Point(115, 188);
                        btnTabela.Location = new Point(790, 531);
                        _TamDescTab = 418;
                        tstbBarraDaEsquerda.Size = new Size(60, 20);
                    } 
                    else if (bllConfiguracaoSistema.Sel_Resolucao_Pdv(bllConexao._Codigo_Conexao) == "1600 x 900")
                    {
                        panTabela.Size = new Size(1045, 577);
                        dtItems.Size = new Size(1038, 505);
                        panTotalProdutos.Location = new Point(746, 688);
                        panTotalProdutos.Size = new Size(830, 120);
                        lblTotalProdutos.Location = new Point(591, 0);
                        lblValorTotal.Location = new Point(301, -1);
                        btnExcluirCliente.Location = new Point(3, 547);
                        panCabecalho.Size = new Size(1560, 65);
                        lblMensagemTopo.Size = new Size(1541, 64);
                        panQuantidade.Location = new Point(531, 688);
                        lblCliente.Location = new Point(35, 551);
                        panMenuImagem.Size = new Size(500, 451);
                        lblImagemProduto.Location = new Point(7, 2);
                        pcibImagemProduto.Size = new Size(498, 423);
                        lblLegendaImagem.Location = new Point(115, 180);
                        btnTabela.Location = new Point(962, 547);
                        _TamDescTab = 588;
                        tstbBarraDaEsquerda.Size = new Size(150, 20);
                    }  
                    */
                    bllVenda.Excluir_Venda_Atual_PDV("Tabela[2]", bllConexao._Codigo_Conexao);
                    //
                    bllVenda.Excluir_Consumidor_PDV("Tabela[2]", bllConexao._Codigo_Conexao);
                    //
                    if (bllAbert_Fech_Caixa.Sel_Aberto_Fechado_Caixa(tslblVersao.Text) == 0)
                    {
                        if (bllVenda.Sel_Item_PDV_Todos(btnTabela.Text, bllConexao._Codigo_Conexao) != null || bllVenda.Sel_Dados_Atuais_PDV(bllConexao._Codigo_Conexao) != null)
                        {
                            ...
                            if (dr["id_devolucao"].ToString() == "0" & dr["id_orcamento"].ToString() == "0")
                            {
                                if (Convert.ToInt32(dr["id_consumidor_pdv"]) != 0)
                                {
                                    ...
                                    //
                                    if (dr["nome_consumidor_pdv"].ToString().Length > 30)
                                    {
                                        lblCliente.Text = "Consumidor: " + dr["id_consumidor_pdv"].ToString() + "—" + dr["nome_consumidor_pdv"].ToString().Substring(0, 30) + "...—" + dr["cpf_cnpj_consumidor_pdv"].ToString();
                                    }
                                    else
                                    {
                                        lblCliente.Text = "Consumidor: " + dr["id_consumidor_pdv"].ToString() + "—" + dr["nome_consumidor_pdv"].ToString() + "—" + dr["cpf_cnpj_consumidor_pdv"].ToString();
                                    }
                                    //                                
                                ...
                                else
                                {
                                    ...
                                    lblCliente.Text = "Consumidor: Não identificado.";
                                    bllVenda._PDV_PesqCliente_Tabela = null;
                                    btnExcluirCliente.Enabled = false;
                                }
                                //
                                if (bllVenda.Sel_Item_PDV_Todos(btnTabela.Text, bllConexao._Codigo_Conexao) != null)
                                {
                                    dtItems.DataSource = bllVenda.Sel_Item_PDV_Todos(btnTabela.Text, bllConexao._Codigo_Conexao);
                                    //
                                    ...
                                    //
                                    lblMensagemTopo.Font = new Font("Microsoft Sans Serif", 22);
                                    //
                                    lblMensagemTopo.ForeColor = Color.Blue;
                                }
                                else
                                {
                                    lblMensagemTopo.Font = new Font("Calibri", 44, FontStyle.Bold);
                                    lblMensagemTopo.ForeColor = Color.Blue;
                                    lblMensagemTopo.Text = "CAIXA LIVRE";
                                }
                                //
                            ...
                            else if (dr["id_devolucao"].ToString() != "0")
                            {
                                ...
                                if (bllDevolucao.Sel_Dados_Devolucao(bllVenda._Cod_Devolucao) != null)
                                {
                                    ...
                                    if (Convert.ToInt32(dr["id_consumidor"]) != 0)
                                    {
                                        ...
                                        {
                                            lblCliente.Text = "Consumidor: " + dr["id_consumidor"].ToString() + "—" + dr["nome_consumidor"].ToString().Substring(0, 30) + "...—" + dr["cpf_cnpj_consumidor"].ToString();
                                        }
                                        else
                                        {
                                            lblCliente.Text = "Consumidor: " + dr["id_consumidor"].ToString() + "—" + dr["nome_consumidor"].ToString() + "—" + dr["cpf_cnpj_consumidor"].ToString();
                                        }
                                    }
                                    else
                                    {
                                    ...
                                    //
                                    caporcToolStripMenuItem.Enabled = false;
                                    quantidadeToolStripMenuItem.Enabled = false;
                                    clienteToolStripMenuItem.Enabled = false;
                                    capturarToolStripMenuItem.Enabled = false;
                                    devolucaoF8ToolStripMenuItem.Enabled = false;
                                    abrirCaixaToolStripMenuItem.Enabled = false;
                                    pausarCaixaToolStripMenuItem.Enabled = false;
                                    ...
                                    sangriaSuprimentoToolStripMenuItem.Enabled = false;
                                    históricoDoCaixaToolStripMenuItem.Enabled = false;
                                    toolStripMenuItem2.Enabled = true;
                                    panProdutos.Enabled = false;
                                    panMenuImagem.Enabled = true;
                                    panTabela.Enabled = true;
                                    panQuantidade.Enabled = false;
                                    panTotalProdutos.Enabled = false;
                                    btnExcluirCliente.Enabled = false;
                                }
                                else
                                {
                            ...
                            else if (dr["id_orcamento"].ToString() != "0")
                            {
                                ...
                                if (bllOrcamento.Sel_Dados_Orcamento(bllVenda._Cod_Orcamento) != null)
                                {
                                    ...
                                    históricoDoCaixaToolStripMenuItem.Enabled = false;
                                    toolStripMenuItem2.Enabled = true;
                                    panProdutos.Enabled = true;
                                    panMenuImagem.Enabled = true;
                                    panTabela.Enabled = true;
                                    panQuantidade.Enabled = true;
                                    panTotalProdutos.Enabled = true;
                                    btnExcluirCliente.Enabled = false;
                                }
                            }
                        }
                    ...
                    else if (bllAbert_Fech_Caixa.Sel_Aberto_Fechado_Caixa(tslblVersao.Text) == 1)
                    {
                        ...
                        históricoDoCaixaToolStripMenuItem.Enabled = false;
                        contasAPagarToolStripMenuItem.Enabled = false;
                        adicionarObservaçãoToolStripMenuItem.Enabled = false;
                        menuNFeNFCeToolStripMenuItem.Enabled = false;
                        vendasToolStripMenuItem.Enabled = false;
                        devoluçõesToolStripMenuItem.Enabled = false;
                        orçamentosToolStripMenuItem.Enabled = false;
                        //
                        ...
                        Desabilitar();
                        //
                        aplicativoToolStripMenuItem.Select();
                    }
                    else
                    {
                        sangriaSuprimentoToolStripMenuItem.Enabled = false;
                        ...
                        //
                        lblMensagemTopo.Font = new Font("Calibri", 44, FontStyle.Bold);
                        lblMensagemTopo.ForeColor = Color.Red;
                        lblMensagemTopo.Text = "CAIXA FECHADO";
                        //
                        txtProduto.Text = null;
                        txtQuantidade.Text = null;
                        txtUnitario.Text = null;
        ...
        private void Cancelar_Venda_Atual()
        {
            try
            {
                ...
                else if (btnTabela.Text != "Tabela [1]")
                {
                    mensagem = "Deseja cancelar uma possível venda na 'Tabela [2]'?";
                }
                else
                {
                    mensagem = "Deseja cancelar uma possível venda atual?";
                ...
                if (DialogResult == DialogResult.Yes)
                {
                    if (bllUsuario.Sel_Permitir_Canc_Exc_Item_Venda_Usuario(tslblUsuario.Text))
                    {
                        bllVenda.Excluir_Venda_Atual_PDV(btnTabela.Text, bllConexao._Codigo_Conexao);
                        bllVenda.Excluir_Consumidor_PDV(btnTabela.Text, bllConexao._Codigo_Conexao);
                        //
                        if (btnTabela.Text == "Tabela [1]")
                        {
                        ...
                        {
                            timerTabela.Stop();
                            btnTabela.Text = "Tabela [1]";
                            btnTabela.ForeColor = Color.Black;
                            //
                            bllVenda._Quantidade = null;
                            _Quantidade = "1";
                            //
                            DataRow dr = bllVenda.Sel_Dados_Atuais_PDV(bllConexao._Codigo_Conexao).Rows[0];
                            //
                            if (Convert.ToInt32(dr["id_consumidor_pdv"]) != 0 || dr["nome_consumidor_pdv"].ToString() != "" || dr["cpf_cnpj_consumidor_pdv"].ToString() != "")
                            {
                                lblCliente.Enabled = true;
                                //
                                bllVenda._PDV_PesqCliente_Tabela = dr["id_consumidor_pdv"].ToString() + "—" + dr["nome_consumidor_pdv"].ToString() + "—" + dr["cpf_cnpj_consumidor_pdv"].ToString(); ;
                    ...
                    {
                        using (FrmLoginUsuarioPerm Login = new FrmLoginUsuarioPerm(tslblUsuario.Text, tslblVersao.Text, "Excluir_Item"))
                        {
                            if (Login.ShowDialog() == DialogResult.OK)
                            {
                                if (bllVenda._Excluir_Item == 1)
                                {
                                    ...
                                    if (btnTabela.Text == "Tabela [1]")
                                    {
                                        ...
                                        btnExcluirCliente.Enabled = false;
                                        //
                                        bllRegistroAtividades.Salvar("CANCELOU UMA VENDA POR COMPLETO NO PDV", "VENDAS", "0", tslblUsuario.Text, tslblVersao.Text);
                                        //
                                        MessageBox.Show("Dados excluídos com sucesso.", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                        //
                                        Habilitar_Padrao();
        ...
        {
            panProdutos.Enabled = false;
            panTabela.Enabled = false;
            panMenuImagem.Enabled = false;
            panQuantidade.Enabled = false;
            panTotalProdutos.Enabled = false;
        ...
        private void Habilitar_Padrao()
        {
            ...
            panTotalProdutos.Enabled = true;
            toolStripMenuItem2.Enabled = false;
            caporcToolStripMenuItem.Enabled = true;
            quantidadeToolStripMenuItem.Enabled = true;
            cancelarToolStripMenuItem.Enabled = false;
            clienteToolStripMenuItem.Enabled = true;
            capturarToolStripMenuItem.Enabled = true;
            devolucaoF8ToolStripMenuItem.Enabled = true;
            contasAPagarToolStripMenuItem.Enabled = true;
            históricoDoCaixaToolStripMenuItem.Enabled = true;
            contasAReceberToolStripMenuItem.Enabled = true;
            sangriaSuprimentoToolStripMenuItem.Enabled = true;
            adicionarObservaçãoToolStripMenuItem.Enabled = true;
            menuNFeNFCeToolStripMenuItem.Enabled = true;
            vendasToolStripMenuItem.Enabled = true;
            orçamentosToolStripMenuItem.Enabled = true;
            devoluçõesToolStripMenuItem.Enabled = true;
        }
            ...
            try
            {
                ...
                using (FrmInformar Inf = new FrmInformar())
                {
                    if (Inf.ShowDialog() == DialogResult.OK)
                    {
                        ...
                        {
                            using (FrmPesqConsumidor Clie = new FrmPesqConsumidor(0, btnTabela.Text, tslblUsuario.Text, tslblVersao.Text))
                            {
                                if (Clie.ShowDialog() == DialogResult.OK)
                                {
                                    ...
                                    //
                                    string cpfcnpj = items[2];
                                    if (cpfcnpj == "  .   .   /    -" || cpfcnpj == "__.___.___/____-__" || cpfcnpj == "   .   .   -" || cpfcnpj == "___.___.___-__")
                                    {
                                        cpfcnpj = "";
                                    }
                                    else
                                    ...
                                    //
                                    if (items[1].Length > 30)
                                    {
                                        lblCliente.Text = items[0] + "—" + items[1].Substring(0, 30) + "...—" + items[2];
                                    }
                                    else
                                    {
                                        lblCliente.Text = items[0] + "—" + items[1] + "—" + items[2];
                                    }
                                    //
                        ...
                        {
                            using (FrmInfConsManual Man = new FrmInfConsManual(btnTabela.Text, tslblUsuario.Text, tslblVersao.Text))
                            {
                                if (Man.ShowDialog() == DialogResult.OK)
                                {
                                    ...
                                    else
                                    {
                                        if (items[1].Length > 30)
                                        {
                                            lblCliente.Text = items[0] + "—" + items[1].Substring(0, 30) + "...";
                                        }
                                        else
                                        {
                                            lblCliente.Text = items[0] + "—" + items[1];
                                        }
                                    }
                                    //
                                    if (bllConfiguracaoSistema.Sel_Alertar_Observacao() == true)
        ...
        private void Orcamento()
        {
            if (bllUsuario.Sel_Reallizar_Orcamento_Usuario(tslblUsuario.Text) == true)
            {
                ...
                {
                    this.Enabled = false;
                    using (FrmCadOrcamento Orc = new FrmCadOrcamento(tslblUsuario.Text, tslblVersao.Text)) 
                    {
            ...
            {
                using (FrmLoginUsuarioPerm Login = new FrmLoginUsuarioPerm(tslblUsuario.Text, tslblVersao.Text, "Realizar_Orcamento"))
                {
                    if (Login.ShowDialog() == DialogResult.OK)
                    {
        ...
        private void Pagamento()
        {
            //try
            //{
                if (bllConfiguracaoSistema.Sel_Contingencia_NFCe() == true & btnTipoVenda.Text == "NFCe")
                {
                    lblContAtiva.Visible = true;
                }
                else
                ...
                if (bllVenda._PDV_PesqCliente_Tabela != null)
                {
                    ...
                    //
                    /*
                    if (btnTipoVenda.Text == "NFCe" & items[2].Length == 18)
                    {
                        ...
                        if (DialogResult == DialogResult.Yes)
                        {
                            ...
                            lblTipo.Text = "NFe (Nota Fiscal Eletrônica - Modelo 55):";
                            //
                            bllConfiguracaoSistema.Alterar_Tipo_Documento_PDV(btnTipoVenda.Text, bllConexao._Codigo_Conexao);
                            //
                            _NFCe_Ativo = true;
                        }
                        else
                    ...
                    */
                    //
                    if (items[0] == "0" & btnTipoVenda.Text == "NFe")
                    {
                        MessageBox.Show("É necessário identificar o através do Cadastro para emitir um documento NFe modelo 55.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                        return;
                    }
                }
                else if (bllVenda._PDV_PesqCliente_Tabela == null & btnTipoVenda.Text == "NFe")
                {
                ...
                using (FrmFormaPagamento Pag = new FrmFormaPagamento(lblValorTotal.Text.Replace("R$ ", ""), Convert.ToDecimal(totalsub).ToString("n2", new CultureInfo("pt-BR")), Formulario, Convert.ToDecimal(valoracrescimoitem).ToString("n2", new CultureInfo("pt-BR")), Convert.ToDecimal(valordescontoitem).ToString("n2", new CultureInfo("pt-BR")), tslblUsuario.Text, tslblVersao.Text))
                {
                    if (Pag.ShowDialog() == DialogResult.OK)
                    {
                        if (bllVenda._Nota_Promissoria == true)
                        {
                            ...
                            bllVenda.Salvar_Forma_Pagamento("1", items[0].ToString(), items[2].ToString(), _Valor_Real, _Cod_Venda, _Data, _Hora, tslblVersao.Text, tslblUsuario.Text);
                            //
                            ...
                            {
                                bllContasReceber.Salvar("0", "ENTRADA DE VENDA EM NOTA PROMISSORIA", DateTime.Now.ToString("dd/MM/yyyy").Replace('/', '.'), DateTime.Now.ToString("dd/MM/yyyy").Replace('/', '.'), "3—CONTAS A RECEBER NO GERAL", "3—GERAL", bllVenda._Valor_Entrada_Promissoria, _Cod_Consumidor + "—" + _Nome_Consumidor, "", "CLIENTES", "", "NOTA PROMISSORIA", bllVenda._Valor_Entrada_Promissoria, tslblUsuario.Text, _Data, _Hora, _Cod_Venda, "FINALIZADA", tslblVersao.Text, "");
                                //
                                _Cod_Conta_Receber = bllVenda.Sel_Ultima_Conta_Receber_PDV();
                                //
                                bllVenda.Salvar_Pagamento_Conta_Receber_PDV("1", bllVenda._Forma_Ent_Pagamento_Promissoria, bllVenda._Valor_Entrada_Promissoria, _Cod_Conta_Receber, tslblUsuario.Text, tslblVersao.Text, _Data, _Hora);
                                //
                                bllFluxoCaixa.Salvar(_Data, _Hora, "ENTRADA", "VENDA DE PRODUTOS NO PDV", bllVenda._Valor_Entrada_Promissoria, _Cod_Venda, tslblUsuario.Text, tslblVersao.Text);
                            }
                            //
                            ...
                            if (btnTipoVenda.Text == "NFCe")
                            {
                                ...
                                //
                                if (bllDFe.Transmitir_NFCe(_Ult_Codigo_DFe, tslblVersao.Text, false) == contingencia)
                                {
                                    ...
                                    //
                                    bllDFe.Transmitir_NFCe(_Ult_Codigo_DFe, tslblVersao.Text, true);
                                }
                                //
                                bllClieCons.Alterar_CPF_CNPJ_Clie_Zerado(null, null);
                            ...
                            else if (btnTipoVenda.Text == "NFe")
                            {
                                ...
                                //
                                using (FrmCadNFeNFCe NFe = new FrmCadNFeNFCe(tslblUsuario.Text, tslblVersao.Text, 2, null, null, _Ult_Codigo_DFe, 0, false))
                                {
                            ...
                            //
                            bllRegistroAtividades.Salvar("VENDA DE PRODUTOS NO PDV", "VENDAS", _Cod_Venda, tslblUsuario.Text, tslblVersao.Text);
                            //
                            if (bllConfiguracaoSistema.Sel_Tipo_Imp_NNF(bllConexao._Codigo_Conexao) == "" & btnTipoVenda.Text == "DAV")
                            {
                            ...
                            else if (bllConfiguracaoSistema.Sel_Tipo_Imp_NNF(bllConexao._Codigo_Conexao) == "Impressora Térmica(58mm)" & btnTipoVenda.Text == "DAV")
                            {
                                _Trabalho = 1;
                            ...
                            else if (bllConfiguracaoSistema.Sel_Tipo_Imp_NNF(bllConexao._Codigo_Conexao) == "Impressora Térmica(80mm)" & btnTipoVenda.Text == "DAV")
                            {
                                _Trabalho = 0;
                                if (bllConfiguracaoSistema.Sel_Nome_Imp_NNF(bllConexao._Codigo_Conexao) == null || bllConfiguracaoSistema.Sel_Nome_Imp_NNF(bllConexao._Codigo_Conexao) == "")
                                {
                            ...
                            else if (bllConfiguracaoSistema.Sel_Tipo_Imp_NNF(bllConexao._Codigo_Conexao) == "A4(Mostrar na Tela)" & btnTipoVenda.Text == "DAV")
                            {
                                Process.Start(bllVenda.GerarDAV(1, _Cod_Venda));
                            }
                            else if (bllConfiguracaoSistema.Sel_Tipo_Imp_NNF(bllConexao._Codigo_Conexao) == "Impressora Térmica(80mm)(Mostrar na Tela)" & btnTipoVenda.Text == "DAV")
                            {
                                Process.Start(bllVenda.GerarDAV(1, _Cod_Venda));
                            }
                            // 
                            ...
                            else
                            {
                                ...
                                btnTabela.ForeColor = Color.Black;
                                //
                                dr = bllVenda.Sel_Dados_Atuais_PDV(bllConexao._Codigo_Conexao).Rows[0];
                                //
                                if (Convert.ToInt32(dr["id_consumidor_pdv"]) != 0 || dr["nome_consumidor_pdv"].ToString() != "" || dr["cpf_cnpj_consumidor_pdv"].ToString() != "")
                                {
                                    lblCliente.Enabled = true;
                            ...
                            //
                            this.TopMost = true;
                            using (FrmTroco Troco = new FrmTroco(Convert.ToDecimal(_Troco).ToString("n2", new CultureInfo("pt-BR")), _Cod_Venda, tslblUsuario.Text, tslblVersao.Text))
                            {
                        ...
                        {
                            if (_Devolucao == true & btnTabela.Text == "Tabela [1]")
                            {
                            ...
                            else if (_Orcamento == true & btnTabela.Text == "Tabela [1]")
                            {
                            ...
                            //
                            bllVenda.Salvar_Venda(bllVenda._PDV_PesqCliente_Tabela, bllVenda._Desconto_Porc, bllVenda._Valor_Desconto, bllVenda._Acrescimo_Porc, bllVenda._Valor_Acrescimo, btnTipoVenda.Text, bllVenda._Total, bllVenda._Total_Real, bllVenda._Observacao, tslblUsuario.Text, tslblVersao.Text, bllVenda._Troco, bllVenda._Valor_Total_Pago, acresc_item, desc_item, bllVenda._Cod_Orcamento, bllVenda._Cod_Devolucao, null, false);
                            //
                            DataRow dr = bllVenda.Sel_Dados_Venda_A_Finalizar().Rows[0];
                            //
                            _Cod_Venda = dr["id_venda"].ToString();
                            ...
                            if (bllVenda._PDV_Forma_Pagamento.Count > 1)
                            {
                                ...
                                for (int i = 0; i < bllVenda._PDV_Forma_Pagamento.Count; i++)
                                {
                                    ...
                                    bllVenda.Salvar_Forma_Pagamento((i + 1).ToString(), items[0], items[1], items[2], _Cod_Venda, _Data, _Hora, tslblVersao.Text, tslblUsuario.Text);
                                    //
                                    ...
                                    {
                                        bllFluxoCaixa.Salvar(_Data, _Hora, "ENTRADA", "VENDA DE PRODUTOS NO PDV", valor_total_pago.ToString(), _Cod_Venda, tslblUsuario.Text, tslblVersao.Text);
                                    }
                                    //
                            ...
                            {
                                string[] items = bllVenda._PDV_Forma_Pagamento[0].ToString().Split('—');
                                bllVenda.Salvar_Forma_Pagamento("1", items[0].ToString(), items[1].ToString(), items[2].ToString(), _Cod_Venda, _Data, _Hora, tslblVersao.Text, tslblUsuario.Text);
                                //
                                if (items[1].ToString() == "CREDITO LOJA")
                                {
                                    bllVenda.Baixa_Credito_Loja_Cliente(_Cod_Consumidor, items[2].ToString());
                                ...
                                {
                                    bllFluxoCaixa.Salvar(_Data, _Hora, "ENTRADA", "VENDA DE PRODUTOS NO PDV", _Valor_Real, _Cod_Venda, tslblUsuario.Text, tslblVersao.Text);
                                }
                            }
                            //
                            for (int i = 0; i < bllVenda._Dados_Cheque.Count; i++)
                            {
                                ...
                                //
                                bllControleCheque.Salvar(items[0] + "—" + items[1] + "—" + items[2], items[3] + "—" + items[4], items[5], items[6], items[7], items[8], items[9], items[10], items[11], _Cod_Usuario + "—" + _Nome_Usuario, tslblVersao.Text, "CLIENTES", _Cod_Venda, "VENDAS");
                            }
                            //
                            if (btnTipoVenda.Text == "NFCe")
                            {
                            ...
                            else if (btnTipoVenda.Text == "NFe")
                            {
                                ...
                                using (FrmCadNFeNFCe NFe = new FrmCadNFeNFCe(tslblUsuario.Text, tslblVersao.Text, 2, null, null, _Ult_Codigo_DFe, 0, false))
                                {
                                    if (NFe.ShowDialog() == DialogResult.Abort)
                                    {
                                        MessageBox.Show("O documento fiscal [ Cód: " + _Ult_Codigo_DFe + " ] referente a venda atual se encontra pendente, é necessário verificar o motivo e transmitir.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                    }
                                }
                            }
                            //
        ...
        */
        ...
        public void Capturar()
        {
            ...
            {
                this.Enabled = false;
                using (FrmCapturar Cap = new FrmCapturar(tslblUsuario.Text, tslblVersao.Text))
                {
                    if (Cap.ShowDialog() == DialogResult.OK)
                    {
                                    ...
                                    if (bllDevolucao.Sel_Itens_Prod_Devolucao(bllVenda._Cod_Devolucao) != null)
                                    {
                                        if (bllVenda.Sel_Devolucao_Venda_Ver(bllVenda._Cod_Devolucao) == false)
                                        {
                                            ...
                                            if (Convert.ToInt32(dr["id_consumidor"]) != 0)
                                            {
                                                lblCliente.Enabled = true;
                                                //
                                                bllVenda.Alterar_Consumidor_PDV(dr["id_consumidor"].ToString(), dr["nome_consumidor"].ToString(), dr["cpf_cnpj_consumidor"].ToString(), btnTabela.Text, bllConexao._Codigo_Conexao);
                                                //
                                                bllVenda._PDV_PesqCliente_Tabela = dr["id_consumidor"].ToString() + "—" + dr["nome_consumidor"].ToString() + "—" + dr["cpf_cnpj_consumidor"].ToString();
                                                //
                                                if (dr["nome_consumidor"].ToString().Length > 30)
                        ...
                        {
                            using (FrmCapturarOrcamento Orc = new FrmCapturarOrcamento(0, tslblUsuario.Text, tslblVersao.Text))
                            {
                                if (Orc.ShowDialog() == DialogResult.OK)
                                {
                                    ...
                                    for (int a = 0; a < bllOrcamento.Sel_Itens_Orcamento_Orc(bllVenda._Cod_Orcamento).Rows.Count; a++)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            //
                                            bllVenda.Salvar_Items_PDV_Orcamento((dtItems.Rows.Count + 1).ToString(), drProd["id_produto"].ToString(), drProd["descricao"].ToString(), dr["valor_unitario"].ToString(), dr["um"].ToString(), dr["quantidade"].ToString(), total_acrescimo, total_desconto, btnTabela.Text, bllConexao._Codigo_Conexao, "PRODUTO");
                                            //
                                            dtItems.DataSource = bllVenda.Sel_Item_PDV_Todos(btnTabela.Text, bllConexao._Codigo_Conexao);
                                        }
                                    }
                        ...
                        {
                            using (FrmCapturarVenda Venda = new FrmCapturarVenda(1, tslblUsuario.Text, tslblVersao.Text))
                            {
                                if (Venda.ShowDialog() == DialogResult.OK)
                                {
                                    ...
                                    for (int a = 0; a < bllVenda.Sel_Itens_Venda_Venda(bllVenda._Cod_Venda).Rows.Count; a++)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            string total_desconto = (Convert.ToDecimal(dr["valor_desconto"]) + Convert.ToDecimal(dr["valor_desconto_item"])).ToString();
                                            //
                                            bllVenda.Salvar_Items_PDV((dtItems.Rows.Count + 1).ToString(), drProd["id_produto"].ToString(), drProd["descricao"].ToString(), drProd["preco"].ToString(), drProd["um"].ToString(), dr["quantidade"].ToString(), drProd["acrescimo_porc"].ToString(), drProd["desconto_porc"].ToString(), btnTabela.Text, bllConexao._Codigo_Conexao, "PRODUTO");
                                            //
                                            dtItems.DataSource = bllVenda.Sel_Item_PDV_Todos(btnTabela.Text, bllConexao._Codigo_Conexao);
                                        }
                                    }
        ...
        public void Excluir_Item()
        {
            try
            {
                ...
                bllVenda.Excluir_Item(SelectedRow.Cells[0].Value.ToString(), btnTabela.Text);

                bllVenda.Atualizar_Item_Dt_Item(dtItems.CurrentRow.Index + 1, dtItems.Rows.Count, btnTabela.Text, bllConexao._Codigo_Conexao);

                bllRegistroAtividades.Salvar("EXCLUIU O ITEM DE CÓDIGO " + SelectedRow.Cells[1].Value.ToString() + " DO PDV", "VENDAS", "0", tslblUsuario.Text, tslblVersao.Text);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        lblMensagemTopo.Font = new Font("Microsoft Sans Serif", 22);
                        lblMensagemTopo.ForeColor = Color.Blue;
                        SelectedRow = dtItems.Rows[dtItems.Rows.Count - 1];
                        lblMensagemTopo.Text = SelectedRow.Cells[2].Value.ToString();
                        //
                        MessageBox.Show("Dados excluídos com sucesso.", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
        ...
        public void Devolucao()
        {
            ...
            {
                this.Enabled = false;
                if (bllUsuario.Sel_Reallizar_Devolucao_Usuario(tslblUsuario.Text) == true)
                {
                    
                    using (FrmDevolucao Dev = new FrmDevolucao(tslblUsuario.Text, tslblVersao.Text))
                    {
                        if (Dev.ShowDialog() == DialogResult.OK)
                        {
                            bllVenda.Alterar_Devolucao_PDV(bllVenda._Cod_Devolucao, bllVenda._Valor_Desconto_Devolucao);
                            ...
                            if (bllVenda._PDV_PesqCliente_Tabela != null)
                            {
                                ...
                                //
                                bllVenda.Alterar_Consumidor_PDV(consumidor[0], consumidor[1], consumidor[2], btnTabela.Text, bllConexao._Codigo_Conexao);
                                //
                                if (consumidor[1].Length > 30)
                                {
                                    lblCliente.Text = "Consumidor: " + consumidor[0] + "—" + consumidor[1].Substring(0, 30) + "...—" + consumidor[2];
                                }
                                else
                                {
                                    lblCliente.Text = "Consumidor: " + consumidor[0] + "—" + consumidor[1] + "—" + consumidor[2];
                                }
                            }
                            else
                            {
                ...
                {
                    using (FrmLoginUsuarioPerm Login = new FrmLoginUsuarioPerm(tslblUsuario.Text, tslblVersao.Text, "Realizar_Devolucao"))
                    {
                        if (Login.ShowDialog() == DialogResult.OK)
                        {
        ...
        private void FrmSistema_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                if (_Acesso_Negado != true)
                {
                    if (btnTabela.Text == "Tabela [1]")
                    {
                        if (bllVenda.Sel_Item_PDV_Todos(btnTabela.Text, bllConexao._Codigo_Conexao) == null & bllOrcamento.Sel_Item_Orc_Todos(bllConexao._Codigo_Conexao) == null)
                        {
                    ...
                    string[] items = tslblUsuario.Text.Remove(0, 12).Split('—');
                    //
                    bllRegistroAtividades.Salvar("O USUARIO " + tslblUsuario.Text.Remove(0, 12) + " DESLOGOU DO SISTEMA SEVEN PDV.", "USUARIO", items[0], tslblUsuario.Text, tslblVersao.Text);
                    //
                    using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                    {
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento formclosing do formulário FrmSistema PDV.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento formclosing do formulário FrmSistema PDV.");
        ...
        private void duplicataToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void duplicataToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }

        private void quantidadeToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void quantidadeToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }

        private void cancelarToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void cancelarToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }
        ...
        private void clienteToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }
        ...
        private void btnProcurarProd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (txtProduto.Text == "")
                {
                    if (bllUsuario.Sel_Mostrar_Dados_Prod_Item_Usuario(tslblUsuario.Text) == true)
                    {
                        using (FrmPesqProduto Prod = new FrmPesqProduto(3, dtItems.Rows.Count, tslblUsuario.Text, tslblVersao.Text, _Quantidade, btnTabela.Text, btnTipoVenda.Text))
                        {
                            if (Prod.ShowDialog() == DialogResult.OK)
                            {
                                using (FrmAdicionarItem Item = new FrmAdicionarItem(dtItems.Rows.Count, 2, btnTabela.Text, _Quantidade))
                                {
                    ...
                    {
                        using (FrmPesqProduto Prod = new FrmPesqProduto(0, dtItems.Rows.Count + 1, tslblUsuario.Text, tslblVersao.Text, _Quantidade, btnTabela.Text, btnTipoVenda.Text))
                        {
                            if (Prod.ShowDialog() == DialogResult.OK)
                            {
                                dtItems.DataSource = bllVenda.Sel_Item_PDV_Todos(btnTabela.Text, bllConexao._Codigo_Conexao);
                        ...
                        if (txtProduto.Text.Replace(@"\", "").Replace(@"/", "") != "")
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    bllVenda.Salvar_Items_PDV((dtItems.Rows.Count + 1).ToString(), dr["id_produto"].ToString(), dr["descricao"].ToString(), dr["preco"].ToString(), dr["um"].ToString(), _Quantidade, dr["acrescimo_porc"].ToString(), dr["desconto_porc"].ToString(), btnTabela.Text, bllConexao._Codigo_Conexao, "PRODUTO");
        ...
        private void FrmSistema_KeyUp(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Escape)
            {
                try
                {
                    if (bllUsuario.Sel_Permitir_Finalizar_PDV_Usuario(tslblUsuario.Text) == true)
                    {
                    ...
                    {
                        using (FrmLoginUsuarioPerm Login = new FrmLoginUsuarioPerm(tslblUsuario.Text, tslblVersao.Text, "Permitir_Fin_PDV"))
                        {
                            if (Login.ShowDialog() == DialogResult.OK)
                            {
            ...
            else if (e.KeyCode == Keys.F1 & toolStripMenuItem1.Enabled == true)
            {
                Ajuda();
            }
            else if (e.KeyCode == Keys.F2 & toolStripMenuItem2.Enabled == true)
            {
            ...
            else if (e.KeyCode == Keys.F3 & caporcToolStripMenuItem.Enabled == true)
            {
                if (dtItems.DataSource == null)
                {
                    Orcamento();
            ...
            else if (e.KeyCode == Keys.F4 & quantidadeToolStripMenuItem.Enabled == true)
            {
                Quantidade();
            }
            else if (e.KeyCode == Keys.F5 & cancelarToolStripMenuItem.Enabled == true)
            {
                Cancelar_Venda_Atual();
            }
            else if (e.KeyCode == Keys.F6 & clienteToolStripMenuItem.Enabled == true)
            {
                Identificar_Consumidor();
            }
            else if (e.KeyCode == Keys.F7 & capturarToolStripMenuItem.Enabled == true)
            {
                Capturar();
            }
            else if (e.KeyCode == Keys.F8 & devolucaoF8ToolStripMenuItem.Enabled == true)
            {
                Devolucao();
            }
            else if (e.KeyCode == Keys.Home)
            {
                try
                {
                    if (btnTipoVenda.Text == "DAV")
                    {
                        DialogResult = MessageBox.Show("Deseja alterar o tipo de documento da venda para NFCe (Nota Fiscal de Consumidor Eletrônica Modelo 65)?", "Pergunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                        if (DialogResult == DialogResult.Yes)
                        {
                            btnTipoVenda.Text = "NFCe";
                            lblTipo.Text = "NFCe (Nota Fiscal de Consumidor Eletrônica - Modelo 65):";
        ...
        private void dtItems_CellEnter(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                dtItems.Columns[6].DefaultCellStyle.FormatProvider = new CultureInfo("pt-BR");
                dtItems.Columns[6].DefaultCellStyle.Format = "n2";
                dtItems.Columns[7].DefaultCellStyle.FormatProvider = new CultureInfo("pt-BR");
                dtItems.Columns[7].DefaultCellStyle.Format = "n2";
                dtItems.Columns[8].DefaultCellStyle.FormatProvider = new CultureInfo("pt-BR");
                dtItems.Columns[8].DefaultCellStyle.Format = "n2";
        ...
        {
            dtItems.Columns[0].HeaderText = " Item";
            dtItems.Columns[1].HeaderText = "  Código";
            dtItems.Columns[2].HeaderText = "Descrição";
            dtItems.Columns[3].HeaderText = "  Qtd.";
            dtItems.Columns[4].HeaderText = " UN.";
            dtItems.Columns[5].HeaderText = "Vl. Unit (R$)";
            //
            if (bllConfiguracaoSistema.Sel_Mostrar_Desc_Acresc_Venda(bllConexao._Codigo_Conexao) == true)
            {
                dtItems.Columns[6].Visible = true;
                dtItems.Columns[7].Visible = true;
                dtItems.Columns[8].Visible = true;
                dtItems.Columns[6].HeaderText = "Vl. Item (R$)";
                dtItems.Columns[7].HeaderText = "Vl. do Desc. - (R$)";
                dtItems.Columns[8].HeaderText = "Vl. do Acrésc. + (R$)";
            }
            else
            {
            ...
            dtItems.Columns[9].HeaderText = "Vl. Total (R$)";
            //
            dtItems.Columns[0].Width = 56;
            dtItems.Columns[1].Width = 78;
            dtItems.Columns[2].Width = _TamDescTab;
            dtItems.Columns[3].Width = 70;
            dtItems.Columns[4].Width = 56;
            dtItems.Columns[5].Width = 130;
            dtItems.Columns[6].Width = 130;
            dtItems.Columns[7].Width = 130;
            dtItems.Columns[8].Width = 130;
            dtItems.Columns[9].Width = 130;
            //
            dtItems.Columns[0].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[0].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[1].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[1].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[2].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[2].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[3].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[3].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[4].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[4].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[5].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[5].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[6].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[6].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[7].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[7].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[8].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[8].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[9].HeaderCell.Style.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dtItems.Columns[9].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            //
            dtItems.DefaultCellStyle.Font = new Font(dtItems.Font, FontStyle.Bold);
            //
            ...
            //
            lblValorTotal.Text = "R$ " + total.ToString("n2", new CultureInfo("pt-BR"));
        }
        ...
        private void dtItems_DataSourceChanged(object sender, EventArgs e)
        {
            if (dtItems.DataSource != null)
            {
                for (int i = 0; i < dtItems.Rows.Count; i++)
                {
                    if (_Alternar_Cor_DtItem == true)
                    {
                        dtItems.Rows[i].DefaultCellStyle.BackColor = Color.LightGray;
                        _Alternar_Cor_DtItem = false;
                    }
                    else
                    {
                        dtItems.Rows[i].DefaultCellStyle.BackColor = Color.Silver;
                        _Alternar_Cor_DtItem = true;
                    }
                }
                //
                cancelarToolStripMenuItem.Enabled = true;
                ...
                pcibImagemProduto.Visible = true;
                devolucaoF8ToolStripMenuItem.Enabled = false;
        ...
        private void dtItems_RowsRemoved(object sender, DataGridViewRowsRemovedEventArgs e)
        {
            lblQuantidadeItem.Text = "0";
        }
        ...
        private void dtItems_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }

        private void dtItems_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            if (dtItems.DataSource != null)
            {
                for (int i = 0; i < dtItems.Rows.Count; i++)
        ...
        private void btnExcluirItem_Click(object sender, EventArgs e)
        {
            if (dtItems.Rows.Count != 0)
            {
                try
                {
                    ...
                    if (DialogResult == DialogResult.Yes)
                    {
                        if (bllUsuario.Sel_Permitir_Canc_Exc_Item_Venda_Usuario(tslblUsuario.Text) == true)
                        {
                            Excluir_Item();
                        }
                        else
                ...
                catch (Exception ex)
                {
                    ...
                    using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                    {
                        writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento Click do btnExcluirItem.");
                    }
                    using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                    {
                        writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento Click do btnExcluirItem.");
        ...
        private void aplicativoToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void aplicativoToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }
        ...
        private void sairToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento sairToolStripMenuItem do formulário FrmSistema PDV.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento sairToolStripMenuItem do formulário FrmSistema PDV.");
        ...
        {
            DialogResult = MessageBox.Show("Deseja remover o consumidor informado?", "Pergunta", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (DialogResult == DialogResult.Yes)
            {
                bllVenda.Excluir_Consumidor_PDV(btnTabela.Text, bllConexao._Codigo_Conexao);
                lblCliente.Text = "Consumidor: Não identificado.";
        ...
        private void btnExcluirCliente_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void btnExcluirCliente_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }
        ...
        private void toolStripMenuItem2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Os itens ainda não foram informados.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
        }
        ...
        private void pcibImagemProduto_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            lblLegendaImagem.Font = new Font(lblLegendaImagem.Font.Name, lblLegendaImagem.Font.SizeInPoints, FontStyle.Bold);
        ...
        private void lblLegendaImagem_Click(object sender, EventArgs e)
        {
            try
            {
                if (_Contem_Imagem == true)
                {
                    ...
                    byte[] imagemBytes = (byte[])dr["imagem_prod"];
                    string caminho = @"C:\Windows\Temp\Sistema SEVEN\Produtos\Imagem\" + SelectedRow.Cells[1].Value.ToString() + ".jpg";
        ...
        private void duplicataToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dtItems.DataSource == null)
            {
                Orcamento();
        ...
        private void button1_Click_2(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (DialogResult == DialogResult.Yes)
                {
                    ...
                    {
                        if (bllUsuario.Sel_Permitir_Alt_Prod_Item_Usuario(tslblUsuario.Text) == true)
                        {
                            int item_selecionado = SelectedRow.Index;
                        ...
                        {
                            using (FrmLoginUsuarioPerm Login = new FrmLoginUsuarioPerm(tslblUsuario.Text, tslblVersao.Text, "Permitir_Alt_Prod_Item"))
                            {
                                if (Login.ShowDialog() == DialogResult.OK)
                                {
        ...
        {
            MessageBox.Show(@"Pesquisa de Produtos: Para pesquisar um produto por código de barras digite o código de barras ou use o leitor de código de barras no produto, para pesquisar um produto apenas pelo código basta incluir na frente do código o caractere ('\' ou '/') na frente da pesquisa e após digitar o código. Por último, para pesquisar um produto com todas as opções de pesquisa basta pressionar o botão enter do seu teclado com a caixa de texto pesquisar produtos vazia ou clicar no botão pesquisar com a caixa de texto pesquisar produto vazia.", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        {
            MessageBox.Show("Item selecionado: Para alterar a quantidade do item selecionado basta informar na caixa de texto [ Quantidade ] o valor desejado após, clicar no botão para alterar a quantidade do item. Para alterar o valor unitário do item selecionado basta informar na caixa de texto [ Valor Unitário ] o valor desejado após, clicar no botão para alterar o valor unitário do item. Para excluir um item basta clicar no botão [ Excluir ] que o mesmo será removido da grade de dados.", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void outrasOpçõesF12ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (dtItems.DataSource == null)
            {
                Devolucao();
        ...
        private void outrasOpçõesF12ToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void outrasOpçõesF12ToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }

        private void outrasOpçõesF12ToolStripMenuItem1_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void outrasOpçõesF12ToolStripMenuItem1_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }
        ...
        private void mudarUsuárioToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    using (FrmLoginUsuario Login = new FrmLoginUsuario(tslblUsuario.Text, tslblVersao.Text, 0))
                    {
                        if (Login.ShowDialog() == DialogResult.OK)
                        {
                            this.DialogResult = DialogResult.Abort;
        ...
        private void históricoDoCaixaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (bllUsuario.Sel_Visualizar_Hist_Caixa_Usuario(tslblUsuario.Text) == true)
                {
                    ...
                    {
                        DataRow dr = bllAbert_Fech_Caixa.Sel_Data_Ultimo_Fech_Caixa_PDV(tslblVersao.Text).Rows[0];
                        //
                    ...
                    //
                    using (FrmRelHistCaixa Caix = new FrmRelHistCaixa(datainicio, datafim, horainicio, horafim, tslblVersao.Text, tslblUsuario.Text, tslblVersao.Text, 2))
                    {
                ...
                {
                    using (FrmLoginUsuarioPerm Login = new FrmLoginUsuarioPerm(tslblUsuario.Text, tslblVersao.Text, "Permitir_Vis_Hist_Caixa"))
                    {
                        if (Login.ShowDialog() == DialogResult.OK)
                        {
        ...
        private void contasAReceberToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //
                if (bllUsuario.Sel_Reallizar_Recebimento_Usuario(tslblUsuario.Text) == true)
                {
                    using (FrmRelContaReceber Conta = new FrmRelContaReceber(tslblUsuario.Text, tslblVersao.Text))
                    {
                ...
                {
                    using (FrmLoginUsuarioPerm Login = new FrmLoginUsuarioPerm(tslblUsuario.Text, tslblVersao.Text, "Permitir_Real_Conta_Receber"))
                    {
                        if (Login.ShowDialog() == DialogResult.OK)
                        {
        ...
        private void sangriaSuprimentoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    using (FrmSangriaSuprimento Sang = new FrmSangriaSuprimento(tslblUsuario.Text, tslblVersao.Text, 0, null))
                    {
                ...
                {
                    using (FrmLoginUsuarioPerm Login = new FrmLoginUsuarioPerm(tslblUsuario.Text, tslblVersao.Text, "Permitir_Real_SangSup"))
                    {
                        if (Login.ShowDialog() == DialogResult.OK)
                        {
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do sangriaSuprimentoToolStripMenuItem.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do sangriaSuprimentoToolStripMenuItem.");
        ...
        {
            //MessageBox.Show("Nº do PDV: " + drComp["id_cadastro_computadores"].ToString() + Environment.NewLine + "Ultima Abertura do Caixa: " + bllAbert_Fech_Caixa.Sel_Data_Abert_Ultima_Abert_Fech_Caixa(tslblVersao.Text) + "\nCód. da última Venda: " + bllVenda.Sel_Cod_Ultima_Venda(tslblVersao.Text, tslblUsuario.Text) + Environment.NewLine + "Cód. do último Orçamento: " + bllVenda.Sel_Cod_Ultimo_Orcamento(tslblVersao.Text, tslblUsuario.Text) + Environment.NewLine + "Cód. da última Devolução: " + bllVenda.Sel_Cod_Ultima_Devolucao(tslblVersao.Text, tslblUsuario.Text) + Environment.NewLine + "Tipo: SERVIDOR" + Environment.NewLine + Environment.NewLine + "Versão: " + _Versao + "\nSistema SEVEN - SISEVEN(C)", "Informação do PDV", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void contasAPagarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //
                if (bllUsuario.Sel_Reallizar_Pagamento_Usuario(tslblUsuario.Text) == true)
                {
                    using (FrmRelContaPagar Conta = new FrmRelContaPagar(tslblUsuario.Text, tslblVersao.Text))
                    {
                        if (Conta.ShowDialog() == DialogResult.Abort)
                        {
                            txtProduto.Select();
                ...
                {
                    using (FrmLoginUsuarioPerm Login = new FrmLoginUsuarioPerm(tslblUsuario.Text, tslblVersao.Text, "Permitir_Real_Conta_Pagar"))
                    {
                        if (Login.ShowDialog() == DialogResult.OK)
                        {
        ...
        private void pausarCaixaToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void pausarCaixaToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }

        private void pausarCaixaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (bllUsuario.Sel_Reallizar_Pausa_Caixa_Usuario(tslblUsuario.Text) == true)
                {
                    string mensagem;
                    //
                    ...
                    if (DialogResult == DialogResult.Yes)
                    {
                        ...
                        else
                        {
                            if (lblMensagemTopo.Text == "CAIXA PAUSADO")
                            {
                                ...
                                lblMensagemTopo.Text = "CAIXA LIVRE";
                                //
                                bllAbert_Fech_Caixa.Alterar_Abertura_Abrir(tslblVersao.Text, "ABERTO");
                                //
                                bllRegistroAtividades.Salvar("RETOMOU O CAIXA.", "ABERT/FECH/CAIXA", "0", tslblUsuario.Text, tslblVersao.Text);
                                //
                                Habilitar_Padrao();
                                //
                                txtProduto.Select();
                            ...
                            else
                            {
                                ...
                                Desabilitar();
                                //
                                bllAbert_Fech_Caixa.Alterar_Abertura_Pausa(tslblVersao.Text, "PAUSADO");
                                //
                                bllRegistroAtividades.Salvar("PAUSOU O CAIXA.", "ABERT/FECH/CAIXA", "0", tslblUsuario.Text, tslblVersao.Text);
                                //
                ...
                {
                    using (FrmLoginUsuarioPerm Login = new FrmLoginUsuarioPerm(tslblUsuario.Text, tslblVersao.Text, "Permitir_Pausar_Caixa"))
                    {
                        if (Login.ShowDialog() == DialogResult.OK)
                        {
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do pausarCaixaToolStripMenuItem.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do pausarCaixaToolStripMenuItem.");
        ...
        private void btnProcurarProd_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento KeyUp do btnProcurarProd.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento Click do btnProcurarProd.");
                }
            }
        }

        private void btnTabela_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void btnTabela_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }
        ...
        private void vendasToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //
                using (FrmRelVenda Vebda = new FrmRelVenda(tslblUsuario.Text, tslblVersao.Text))
                {
                    if (Vebda.ShowDialog() == DialogResult.Abort)
                    {
                        txtProduto.Select();
                    }
                }
        ...
        private void vendasToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }
        ...
        private void btnTipoVenda_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void btnTipoVenda_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }

        private void btnTipoVenda_Click(object sender, EventArgs e)
        {
            try
            {
                if (btnTipoVenda.Text == "DAV")
                {
                    ...
                    for (int i = 0; i < dtItems.Rows.Count; i++)
                    {
                        ...
                        if (dr["ncm"].ToString() == "" || dr["ncm"].ToString() == null)
                        {
                            MessageBox.Show("É necessário ter um NCM válido cadastrado para o produto:\n[ " + SelectedRow.Cells[1].Value.ToString() + " ].", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            return;
                        }
                    }
                }
        ...
        private void menuNFeNFCeToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (bllClieCons._FrmCadClieCons_Ativo == false)
                {
                    ...
                    {
                        using (FrmMenuNFeNFCe Menu = new FrmMenuNFeNFCe(tslblUsuario.Text, tslblVersao.Text, 0, null))
                        {
        ...
        private void outrasOpçõesF12ToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        private void desenvolvedorToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void desenvolvedorToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }
        ...
        private void layoutPDVToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void layoutPDVToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }

        private void layoutPDVToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Enabled = false;
            try
            {
        ...
        {
            bllVersao.CriarArquivoLogLoginServ("seven_pdv", _Versao, null);
        }
        ...
        private void orçamentosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //
                using (FrmRelOrcamento Orc = new FrmRelOrcamento(tslblUsuario.Text, tslblVersao.Text))
                {
                    if (Orc.ShowDialog() == DialogResult.Abort)
                    {
                        txtProduto.Select();
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do orçamentosToolStripMenuItem.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do orçamentosToolStripMenuItem.");
        ...
        private void devoluçõesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //
                using (FrmRelDevolucao Dev = new FrmRelDevolucao(tslblUsuario.Text, tslblVersao.Text))
                {
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do devoluçõesToolStripMenuItem.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do devoluçõesToolStripMenuItem.");
        ...
        private void devoluçõesToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void devoluçõesToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }

        private void timerTabela_Tick(object sender, EventArgs e)
        {
            if (btnTabela.ForeColor == Color.Black)
            {
                btnTabela.ForeColor = Color.Red;
            }
            else
            {
                btnTabela.ForeColor = Color.Black;
        ...
        private void outrasOpçõesF12ToolStripMenuItem1_DropDownOpened(object sender, EventArgs e)
        {
            try
            {
                if (bllConfiguracaoSistema.Sel_Abert_Fech_Caixa_Config() == false)
                {
                    ...
                    else if (bllAbert_Fech_Caixa.Sel_Aberto_Fechado_Caixa(tslblVersao.Text) == 1)
                    {
                        abrirCaixaToolStripMenuItem.Enabled = false;
                        fecharCaixaToolStripMenuItem.Enabled = false;
                        pausarCaixaToolStripMenuItem.Enabled = true;
                    }
                    else
                    {
                        abrirCaixaToolStripMenuItem.Enabled = true;
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento DropDownOpened do outrasOpções.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento DropDownOpened do outrasOpções.");
        ...
        private void btnExcluirItem_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
                if (e.KeyCode == Keys.Delete)
            ...
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento KeyUp do btnExcluir.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento Click do btnExcluir.");
                }
            }
        }

        private void adicionarObservaçãoToolStripMenuItem_MouseMove(object sender, MouseEventArgs e)
        {
            this.Cursor = Cursors.Hand;
        }

        private void adicionarObservaçãoToolStripMenuItem_MouseLeave(object sender, EventArgs e)
        {
            this.Cursor = Cursors.Default;
        }

        private void adicionarObservaçãoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Enabled = false;
            using (FrmObservacao Obs = new FrmObservacao(tslblUsuario.Text, tslblVersao.Text))
            {
        ...
        private void FrmSistema_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void lblCliente_Click(object sender, EventArgs e)
        {
            try
            {
                string[] items = lblCliente.Text.Replace("Consumidor: ", "").Split('—');
                //
                if (items[0] == "0")
                {
                    MessageBox.Show("Não é possível exibir as informações deste consumidor pois o mesmo não está cadastrado no sistema.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                }
                else
                {
                    DataRow dr = bllVenda.Sel_PDV_Dados_Cliente_Codigo(items[0]).Rows[0];
                    //
                    MessageBox.Show("Informações do Consumidor:" + Environment.NewLine + Environment.NewLine + "Código: " + dr["id_cliente"].ToString() + Environment.NewLine + "Nome/Razão Social: " + dr["nome"].ToString() + Environment.NewLine + "Nome Fantasia: " + dr["fantasia"].ToString() + Environment.NewLine + "CPF/CNPJ: " + dr["cpf_cnpj"].ToString() + Environment.NewLine + "IE/RG: " + dr["ie_rg"].ToString() + Environment.NewLine + "Gênero: " + dr["genero"].ToString() + Environment.NewLine + "Telefone: " + dr["telefone"].ToString() + Environment.NewLine + "FAX: " + dr["fax"].ToString() + Environment.NewLine + "Celular: " + dr["celular"].ToString() + Environment.NewLine + "Email: " + dr["email"].ToString() + Environment.NewLine + "Endereço: " + dr["endereco"].ToString() + Environment.NewLine + "Número: " + dr["numero"].ToString() + Environment.NewLine + "Complemento: " + dr["complemento"].ToString() + Environment.NewLine + "Bairro: " + dr["bairro"].ToString() + Environment.NewLine + "UF: " + dr["uf"].ToString() + Environment.NewLine + "Cidade: " + dr["cidade"].ToString() + Environment.NewLine + "CEP: " + dr["cep"].ToString(), "Informação", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do lblCliente.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento click do lblCliente.");
