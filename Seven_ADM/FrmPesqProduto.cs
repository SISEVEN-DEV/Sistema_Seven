...
namespace Seven_Sistema
{
    ...
    {
        public FrmPesqProduto(byte formulario, string cod_dfe, string usuario, string cod_pdv_computador, int item, string quantidade)
        {
            InitializeComponent();
        ...
        private void FrmPesqProduto_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_Formulario == 4)
                {
                    ...
                    rbtnBarra.Enabled = false;
                    rbtnPalavraChave.Enabled = false;
                    rbtnReferencia.Enabled = false;
                    rbtnGrupo.Enabled = false;
        ...
        private void rbtnGrupo_CheckedChanged(object sender, EventArgs e)
        {
            ...
            txtpCodigo.Visible = false;
            txtpBarra.Visible = false;
            lblPesquisar.Location = new Point(370, 21);
        ...
        private void btnPesquisar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (rbtnReferencia.Checked == true)
                {
                    if (txtpBarra.Text != "")
                    {
                        if (bllProduto.Sel_Prod_Referencia(txtpBarra.Text, "ATIVO") == null)
                        {
                            dtProd.DataSource = null;
                            MessageBox.Show("Nenhum registro encontrado.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            this.DialogResult = DialogResult.None;
                        ...
                        {
                            dtProd.DataSource = bllProduto.Sel_Prod_Referencia(txtpBarra.Text, "ATIVO");
                            dtProd.Select();
                        }
                    }
                }
                ...
                else if (rbtnTodos.Checked == true)
                {
                    if (_Formulario == 4)
                    {
                        if (bllValidade.Sel_Prod_Todos_Validade(_Cod_DFe) == null)
                        {
                            dtProd.DataSource = null;
                            MessageBox.Show("Nenhum registro encontrado.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                            this.DialogResult = DialogResult.None;
                        ...
                        {
                            dtProd.DataSource = bllValidade.Sel_Prod_Todos_Validade(_Cod_DFe);
                            dtProd.Select();
                        }
                    }
                    else
        ...
        private void dtProd_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_Formulario == 0)
                {
                    ...
                    bllSaidasProdutos._Saidas_Prod_PesqProd_Tabela = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString();
                    this.DialogResult = DialogResult.OK;
                }
                else if (_Formulario == 1)
                {
                    btnIncluir.Select();
                    bllEntradasProdutos._FornProd_Prod_PesqProd_Tabela = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString();
                    this.DialogResult = DialogResult.OK;
                }
                else if (_Formulario == 2)
                {
                    btnIncluir.Select();
                    bllDevolucao._Devolucao_Prod_PesqProd_Tabela = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString();
                    this.DialogResult = DialogResult.OK;
                }
                else if (_Formulario == 3)
                {
                    ...
                    bllDFe._FornDFe_Produto_PesqProduto_Tabela = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString();
                    this.DialogResult = DialogResult.OK;
                }
                else if (_Formulario == 4)
                {
                    btnIncluir.Select();
                    bllValidade._Validade_Prod_PesqProd_Tabela = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString();
                    this.DialogResult = DialogResult.OK;
                }
                else if (_Formulario == 5)
                {
                    btnIncluir.Select();
                    bllInventario._Inv_Prod_PesqProd_Tabela = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString();
                    this.DialogResult = DialogResult.OK;
                }
                else if (_Formulario == 6)
                {
                    ...
                    using (FrmQuantidade Qtde = new FrmQuantidade(0, "1,00"))
                    {
                        if (Qtde.ShowDialog() == DialogResult.OK)
                        {
                            ...
                            if (bllProduto.Sel_Alert_Est_Max_Min_Prod(SelectedRow.Cells[0].Value.ToString()) == true)
                            {
                                if (bllProduto.Ver_Estoque_Min_Prod(SelectedRow.Cells[0].Value.ToString(), bllOS._Quantidade) == true)
                                {
                                    MessageBox.Show("O seu estoque atual junto com a quantidade informada ultrapassou a quantidade de estoque mínimo definido para este produto.", "Atenção", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                                    this.DialogResult = DialogResult.None;
                                }
                            ...
                            bllOS._Produto_PesqProduto_Tabela = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString() + "—" + SelectedRow.Cells[2].Value.ToString() + "—" + SelectedRow.Cells[3].Value.ToString() + "—" + SelectedRow.Cells[21].Value.ToString() + "—" + SelectedRow.Cells[22].Value.ToString() + "—" + SelectedRow.Cells[14].Value.ToString();
                            this.DialogResult = DialogResult.OK;
                        }
                    }
                }
                ...
                else if (_Formulario == 10)
                {
                    btnIncluir.Select();
                    //
                    bllPedAnotaAI._PedAnotaAi_PesqProduto_Tabela = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString();
                    //
                    this.DialogResult = DialogResult.OK;
                }
                ...
                {
                    btnIncluir.Select();
                    bllOS._Produto_PesqProduto_Tabela = SelectedRow.Cells[0].Value.ToString() + "—" + SelectedRow.Cells[1].Value.ToString();
                    this.DialogResult = DialogResult.OK;
                }
            }
            catch (Exception ex)
            {
                ...
                using (StreamWriter writer = new StreamWriter(@"C:\Sistema SEVEN\Config\Log\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento DoubleClick do dtProd.");
                }
                using (StreamWriter writer = new StreamWriter(@"C:\Windows\Temp\Sistema SEVEN\Log de Acoes\" + DateTime.Now.ToShortDateString().Replace('/', '_') + ".txt", true))
                {
                    writer.WriteLine(DateTime.Now.ToShortTimeString() + " - Erro: " + ex.Message + " | Evento DoubleClick do dtProd.");
        ...
        {
            MessageBox.Show("Nesta seção você pesquisará os dados por descrição, código, código de barras, grupo e sub-grupo, palavra-chave, referência e todos os dados cadastrados.", "Informação", MessageBoxButtons.OK, MessageBoxIcon.Information);
            this.DialogResult = DialogResult.None;
        }
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            try
            {
                if (bllUsuario.Sel_Cadastrar_Produtos(_Usuario) == true)
                {
        ...
        private void dtProd_CellLeave(object sender, DataGridViewCellEventArgs e)
        {
