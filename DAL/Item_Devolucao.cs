...
namespace DAL
{
    public class Item_Devolucao : IDisposable
    {
        private int _Codigo;
        ...
        private decimal _Valor_Total_Apos_Desc_Acresc;
        ...
        public decimal Valor_Total_Apos_Desc_Acresc
        {
            get { return _Valor_Total_Apos_Desc_Acresc; }
            set { _Valor_Total_Apos_Desc_Acresc = value; }
        }
        ...
        public void Dispose()
        {
            ...
            _Valor_Total_Apos_Desc_Acresc = 0;
        }
    }
}
