...
namespace DAL
{
    public class Item_DFe : IDisposable
    {
        private int _Codigo;
        ...
        private string _UM;
        private decimal _Total_Aprox_Tributos;
        ...
        public decimal Total_Aprox_Tributos
        {
            get { return _Total_Aprox_Tributos; }
            set { _Total_Aprox_Tributos = value; }
        }
