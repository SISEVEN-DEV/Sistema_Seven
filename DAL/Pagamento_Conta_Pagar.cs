...
namespace DAL
{
    public class Pagamento_Conta_Pagar : IDisposable
    {
        private int _Codigo;
        ...
        public int Cod_Conta_Pagar
        {
            get { return _Cod_Conta_Pagar; }
            set { _Cod_Conta_Pagar = value; }
        }
